...
public final class BenchIOBenchmark extends BenchmarkModule {
    ...
    protected List<Worker<? extends BenchmarkModule>> makeWorkersImpl() {
        ...
        try {
            for (int i = 0; i < numWorkers; i++) {
                ...
                workers.add(new BenchIOWorker(  // Corrigido para usar BenchIOWorker
                        this,
                        i, // workerId
                        hubId, // terminalHubID
    ...
    protected void configureWorkers() {
        ...
        LOG.info("Configurando {} workers para {} hubs e {} salas por hub",
                workConf.getTerminals(), numHubs, numRooms);
    }
