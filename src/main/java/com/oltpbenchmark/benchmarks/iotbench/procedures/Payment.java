...
// import com.oltpbenchmark.benchmarks.iotbench.pojo.Hub;

// public class Payment extends IotBenchProcedure {
...
//          VALUES (?,?,?,?,?,?,?,?)
//     """
//               .formatted(IotBenchConstants.TABLENAME_HISTORY));
...
//           "\n+---------------------------- PAYMENT ----------------------------+");
//       terminalMessage.append("\n Date: ").append(IotBenchUtil.getCurrentTime());
//       terminalMessage.append("\n\n Warehouse: ");
...
//     } else {
//       do {
//         customerWarehouseID = IotBenchUtil.randomNumber(1, numWarehouses, gen);
...
//       return districtID;
//     } else {
//       return IotBenchUtil.randomNumber(1, IotBenchConfig.configDistPerWhse, gen);
//     }
//   }
...
//   private Hub getWarehouse(Connection conn, int w_id) throws SQLException {
...
//       float paymentAmount)
//       throws SQLException {
//     int y = IotBenchUtil.randomNumber(1, 100, gen);
...
//               customerWarehouseID,
//               customerDistrictID,
//               IotBenchUtil.getNonUniformRandomLastNameForRun(gen),
//               conn);
//     } else {
//       // 40% lookups by customer ID
//       c =
//           getCustomerById(
//               customerWarehouseID, customerDistrictID, IotBenchUtil.getCustomerID(gen), conn);
//     }
...
//         Customer c = IotBenchUtil.newCustomerFromResults(rs);
//         c.c_id = c_id;
