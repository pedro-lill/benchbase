...
public class StockLevel extends IotBenchProcedure {
  ...
  public SQLStmt stockGetCountStockSQL =
      new SQLStmt(
        ...
        SELECT COUNT(DISTINCT (S_I_ID)) AS STOCK_COUNT
         ...
         AND S_QUANTITY < ?
    """
              .formatted(IotBenchConstants.TABLENAME_ORDERLINE, IotBenchConstants.TABLENAME_STOCK));
  ...
  public void run(
    ...
    int threshold = IotBenchUtil.randomNumber(10, 20, gen);
