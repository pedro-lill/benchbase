...
// import com.oltpbenchmark.benchmarks.iotbench.pojo.SensorLog;

// public class OrderStatus extends IotBenchProcedure {
...
//     int d_id = IotBenchUtil.randomNumber(terminalDistrictLowerID, terminalDistrictUpperID, gen);
...
//     if (y <= 60) {
//       c_by_name = true;
//       c_last = IotBenchUtil.getNonUniformRandomLastNameForRun(gen);
//     } else {
//       c_by_name = false;
//       c_id = IotBenchUtil.getCustomerID(gen);
//     }
...
//     SensorLog o = getOrderDetails(conn, w_id, d_id, c);
...
//       sb.append(" Date: ");
//       sb.append(IotBenchUtil.getCurrentTime());
//       sb.append("\n\n Warehouse: ");
//       sb.append(w_id);
//       sb.append("\n District:  ");
//       sb.append(d_id);
...
//   private SensorLog getOrderDetails(Connection conn, int w_id, int d_id, Customer c)
//       throws SQLException {
...
//           sb.append(" - ");
//           sb.append(IotBenchUtil.formattedDouble(rs.getDouble("OL_AMOUNT")));
//           sb.append(" - ");
