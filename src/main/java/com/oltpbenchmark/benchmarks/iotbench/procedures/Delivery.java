...
// public class Delivery extends IotBenchProcedure {
...
//     int o_carrier_id = IotBenchUtil.randomNumber(1, 10, gen);
...
//       terminalMessage.append(IotBenchUtil.getCurrentTime());
//       terminalMessage.append("\n\n Warehouse: ");
//       terminalMessage.append(w_id);
//       terminalMessage.append("\n Carrier:   ");
//       terminalMessage.append(o_carrier_id);
//       terminalMessage.append("\n\n Delivered Orders\n");
//       for (int i = 1; i <= IotBenchConfig.configDistPerWhse; i++) {
//         if (orderIDs[i - 1] >= 0) {
