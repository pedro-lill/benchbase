...
// import com.oltpbenchmark.benchmarks.iotbench.IotBenchConfig;
// import com.oltpbenchmark.benchmarks.iotbench.IotBenchConstants;
// import com.oltpbenchmark.benchmarks.iotbench.IotBenchUtil;
// import com.oltpbenchmark.benchmarks.iotbench.IotBenchWorker;
// import com.oltpbenchmark.benchmarks.iotbench.pojo.Device;

// public class NewOrder extends IotBenchProcedure {
...
//            AND C_ID = ?
//     """
//               .formatted(IotBenchConstants.TABLENAME_CUSTOMER));
...
//          WHERE W_ID = ?
//     """
//               .formatted(IotBenchConstants.TABLENAME_WAREHOUSE));
...
//     """
//               .formatted(IotBenchConstants.TABLENAME_DISTRICT));
...
//          VALUES ( ?, ?, ?)
//     """
//               .formatted(IotBenchConstants.TABLENAME_NEWORDER));
...
//          VALUES (?, ?, ?, ?, ?, ?, ?)
//     """
//               .formatted(IotBenchConstants.TABLENAME_OPENORDER));
...
//          WHERE I_ID = ?
//     """
//               .formatted(IotBenchConstants.TABLENAME_ITEM));
...
//     """
//               .formatted(IotBenchConstants.TABLENAME_STOCK));
...
//       itemIDs[i] = IotBenchUtil.getItemID(gen);
//       if (IotBenchUtil.randomNumber(1, 100, gen) > 1) {
//         supplierWarehouseIDs[i] = terminalWarehouseID;
//       } else {
//         do {
//           supplierWarehouseIDs[i] = IotBenchUtil.randomNumber(1, numWarehouses, gen);
//         } while (supplierWarehouseIDs[i] == terminalWarehouseID && numWarehouses > 1);
//         allLocal = 0;
//       }
//       orderQuantities[i] = IotBenchUtil.randomNumber(1, 10, gen);
//     }

//     // we need to cause 1% of the new orders to be rolled back.
//     if (IotBenchUtil.randomNumber(1, 100, gen) == 1) {
//       itemIDs[numItems - 1] = IotBenchConfig.INVALID_ITEM_ID;
//     }
...
//         Device s = getStock(conn, ol_supply_w_id, ol_i_id, ol_quantity);
...
//   private String getDistInfo(int d_id, Device s) {
//     return switch (d_id) {
//       case 1 -> s.s_dist_01;
//       case 2 -> s.s_dist_02;
//       case 3 -> s.s_dist_03;
...
//   private Device getStock(Connection conn, int ol_supply_w_id, int ol_i_id, int ol_quantity)
//       throws SQLException {
