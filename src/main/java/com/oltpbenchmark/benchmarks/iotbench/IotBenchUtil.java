...
import static com.oltpbenchmark.benchmarks.iotbench.IotBenchConfig.dateFormat;

import com.oltpbenchmark.benchmarks.iotbench.pojo.ActionLogs;
import com.oltpbenchmark.benchmarks.iotbench.pojo.AutomationProfile;
import com.oltpbenchmark.benchmarks.iotbench.pojo.Device;
import com.oltpbenchmark.benchmarks.iotbench.pojo.Hub;
import com.oltpbenchmark.benchmarks.iotbench.pojo.Sensor;
import com.oltpbenchmark.benchmarks.iotbench.pojo.SensorLog;
import com.oltpbenchmark.benchmarks.iotbench.pojo.User;
import com.oltpbenchmark.util.RandomGenerator;
import java.sql.ResultSet;
import java.sql.SQLException;
import java.util.Random;

public class IotBenchUtil {
   ...
   */
  public static User newUserFromResults(ResultSet rs) throws SQLException {
    User user = new User();
   ...
   * @throws SQLException for problems getting data from row
   */
  public static AutomationProfile newAutomationProfileFromResults(ResultSet rs)
      throws SQLException {
